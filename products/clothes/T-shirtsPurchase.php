        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4">
              ...
              <div class="card">
                <img src="/Pritam/products/clothesPhoto/t-shirts/T-shirt.jpg" class="card-img-top" alt="...">
            ...
            <div class="col-lg-4">
              <form action = "manage_cart.php" method = "POST">
              <div class="card">
                <img src="/Pritam/products/clothesPhoto/t-shirts/T-shirt2.jpg" class="card-img-top" alt="...">
                <div class="card-body text-center">
            ...
            <div class="col-lg-4">
              <form action = "manage_cart.php" method = "POST">
              <div class="card">
                <img src="/Pritam/products/clothesPhoto/t-shirts/T-shirt3.jpg" class="card-img-top" alt="...">
                <div class="card-body text-center">
